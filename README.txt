...
(Compression Ratio 3.43%) with an accuracy of 99.01%, making PRESTO a strategy comparable to
state-of-the-art NN-compression algorithms.

================================================================================================================================================================================================================================================================================================

HOW IS THE DIRECTORY COMPOSED?
The PRESTO main directory is structured as follows:
...
Main Programs:
- train.py: Trains the network using the PRESTO term.
...
You can use PRESTO either with notebooks or .py files, depending on your preferred workflow.
...
LSQ-PRESTO protocol on ResNet-18 and DeiT-Small, respectively.
