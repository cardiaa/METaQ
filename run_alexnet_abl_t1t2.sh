...
# test_278: AlexNet, ablazione dei termini -- T1+T2, niente entropia.
# Coefficienti (T1,T2,T3) = (1e-5,3e-7,0). Ogni altro flag e' identico negli
...
if [ -e "$LOG_FILE" ]; then
    echo "Leonardo_test_278.log esiste gia': rifiuto di sovrascriverlo." >&2
    exit 1
fi
export LOG_FILE
