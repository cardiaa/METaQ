...
if __name__ == "__main__":
    ...
    while True:  
        with multiprocessing.Manager() as manager:
            ...
            synced = manager.Value('b', False)  # Variabile per indicare sincronizzazione riuscita
            sync_lock = manager.Lock()  

            enhanced_combinations = [params + (arrival_times, sync_failed, sync_lock, synced) for params in param_combinations]
