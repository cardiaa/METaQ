...
def load_data(model_name):
    ...
    if(model_name[:7] == "LeNet-5"):
        ...
        trainset = DataLoader(train_dataset, batch_size=2048, sampler=train_sampler, num_workers=16, pin_memory=True)
        testset = DataLoader(val_dataset, batch_size=2048, shuffle=False, num_workers=16, pin_memory=True)
