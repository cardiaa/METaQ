...
def load_data(model_name):
    ...
    if(model_name[:7] == "LeNet-5"):
        ...
        trainset = DataLoader(train_dataset, batch_size=64, sampler=train_sampler, num_workers=8, pin_memory=True) #with 512 and C=4 it works
...
if __name__ == "__main__":
    ...
    if(model_name == "LeNet-5"):
        ...
        zeta = 50000
        l = 0.5
        n_epochs = 5 # To be increased as soon as I find good configurations
        max_iterations = 15
        train_optimizer = "SGD"  
        entropy_optimizer = "FISTA"  
        pruning = "Y"
